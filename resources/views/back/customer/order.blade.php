                        ...
                        <div class="card-body ">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Address</label>
                                        <input type="text" class="form-control" placeholder="Home Address" disabled=""
                ...
                <div class="card-body table-full-width">
                    ...
                    <table id="bootstrap-table" class="table">
                        <thead>
                            ...
                            <th data-field="start date" data-sortable="true">Received Date</th>
                            <th data-field="end date" data-sortable="true">Delivery Date</th>
